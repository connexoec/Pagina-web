...
// ─────────────────────────────────────────────────────────────
//  RED CONNEXO · página propia (/red)
//  El directorio público de negocios que ya viven en Connexo.
...
function RadarSweep() {
  ...
  return (
    <motion.div
      aria-hidden
      className="pointer-events-none absolute left-1/2 top-0 h-[900px] w-[900px] -translate-x-1/2 rounded-full opacity-[0.16]"
      style={{
        background:
  ...
  return (
    <div className="min-h-screen bg-abyss-950 text-white/90">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-white/[0.06] bg-abyss-900 pt-28 pb-16 sm:pt-36 sm:pb-20">
          ...
          <div className="section-pad relative">
            {/* Migaja de pan: siempre hay camino de vuelta */}
            <Link
              href="/"
            ...
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-base text-white/60 sm:text-lg">
                El directorio de los negocios que cambiaron el papel por un toque.
                No es un listado de anuncios: entras, ves qué hace cada uno y
                saltas directo a su perfil. Sin intermediarios y sin pagar por
                aparecer arriba.
              </p>
              ...
              <div className="mx-auto mt-10 grid max-w-xl grid-cols-3 gap-4">
                {[
                  {
                    n: members.length,
                    v: members.length === 1 ? 'Negocio en la red' : 'Negocios en la red',
                  },
                  {
                    n: rubrosActivos,
                    v: rubrosActivos === 1 ? 'Rubro activo' : 'Rubros activos',
                  },
        ...
        <section className="relative bg-abyss-950 py-16 sm:py-20">
          <div className="section-pad">
                ...
                {ecosystems.map((eco) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {count > 0 && (
                        <span
                          className={isActive ? 'ml-1.5 text-black/60' : 'ml-1.5 text-connexo'}
                        >
                          {count}
                        </span>
                      )}
            ...
            {/* Grilla */}
            {results.length === 0 ? (
              <div className="mx-auto mt-14 max-w-md rounded-2xl border border-white/[0.08] bg-abyss-800 p-10 text-center">
                <p className="font-heading text-xl text-white">Todavía nadie por ahí.</p>
                <p className="mt-3 text-sm text-white/50">
                  La red está abriendo y aún es chica. Prueba con otro rubro, o sé
                  tú quien ocupe ese lugar.
                </p>
                <button
                  onClick={() => {
                    setQuery('')
            ...
            <div className="mx-auto mt-16 max-w-2xl text-center">
              <p className="text-sm text-white/45">
                La red se llena en el orden en que la gente se atreve. No hay
                puestos comprados ni resultados patrocinados: quien entra, aparece.
              </p>
              <a
                href={wa(waMsg.red)}
                target="_blank"
